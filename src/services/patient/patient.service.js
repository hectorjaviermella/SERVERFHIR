...
let getPatient = (base_version) => {
  console.log('entro a getpatient');
  let tempo= resolveSchema(base_version, 'Patient');
...
module.exports.search = (args) =>
  new Promise((resolve, reject) => {
    ...
    console("db", db);
    console("collection ",collection);
  
    console("Patient ", Patient);
